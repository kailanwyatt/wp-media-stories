<?php
/**
 * WP_Media_Stories Test Bootstrapper.
 *
 * @since   0.1
 ...
 * @since 0.1
 */
function _manually_load_wp_media_stories_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/wp-media-stories.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_wp_media_stories_plugin' );
